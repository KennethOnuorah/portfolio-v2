...
export default function NavBar() {
  ...
  return (
    <>
      <nav
        ref={navRef}
        className={`fixed transition-all ${isMenuOpen ? 'bg-white' : 'bg-white/60'} backdrop-blur-sm w-screen top-0 left-0 z-10 flex justify-between flex-row py-6 px-6 items-start md:items-center sm:px-24 xs:py-4`}
